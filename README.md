...
When it comes to **Performance Testing**, most people love to dive straight into — *load*, *stress*, or *spike* testing — because who doesn’t like watching servers cry under pressure, right?
 ...
 But, later somewhere along the way, we trip over Performance metrics, thumb rules etc that makes it more complex and sometimes even confuses what we know uptill now.!

 Sometins we even pause and ask “wait, what are we even testing again?"
...
It focuses on aspescts like **speed, scalability, stability, and responsiveness** of an application. It ensures that the system meets the required performance standards.
...
---
### **3. Performance Testing Process PTLC**
...
4. **Execute** – Run tests gradually, monitor system behavior.
5. **Analyze** – Identify bottlenecks and compare with Service Level Agreements (SLAs).
6. **Tune & Retest (Optional)** – Optimize components and validate improvements.
6. **Report**: Document results - helps Business to make GO/NO-GO decision, and Retest fixes.
